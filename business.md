...
- `brand/voice.md` (built 2026-09-12) still has no real closing pattern for a full post or a landing/offer page — only openers exist for those so far. Fill the next time voice gets worked, and once real new-business posts/hooks exist, replace the old Threads-growth dollar/follower claims that seed the numeric-opener example with new ones.
